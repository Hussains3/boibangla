...
<div class="artical-main">
    ...
    <h1 id="privacypolicy">Privacy Policy for BoiBangla</h1>

    <p>
    At BoiBangla, accessible at Boibangla.com.bd, one of our main priorities is the privacy of our
    visitors. This Privacy Policy document contains types of information that is collected and
    recorded by BoiBangla and how we use it.
    </p>
    <p>
        If you have additional questions or require more information about our Privacy Policy, do not
        hesitate to contact us through email at support@boibangla.com.bd
    </p>
    <p>
    This privacy policy applies only to our online activities and is valid for visitors to our website
    with regards to the information that they shared and/or collect in Boibagla.com.bd. This
    ...
    <h2>Log Files</h2>
    <p>BoiBangla follows a standard procedure of using log files. These files log visitors when they
    ...
    Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The
    ...
    <p>Like any other website, BoiBangla uses „cookies'. These cookies are used to store
    ...
    on BoiBangla, which are sent directly to users' browser. They automatically receive your IP
    ...
    <p>Note that BoiBangla has no access to or control over these cookies that are used by third-party advertisers</p>
    <h2>Third-Party Privacy Policies</h2>
    <p>BoiBangla's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    advising you to consult the respective Privacy Policies of these third-party ad servers for
    more detailed information. It may include their practices and instructions about how to opt-out of certain options. You
    may find a complete list of these Privacy Policies and their links
    ...
    online activity.</p>
    <p>BoiBangla does not knowingly collect any Personal Identifiable Information from children
    ...
    <p>We reserve the right to change or update these terms and policies at any time by placing a
    prominent notice on our site. Such changes shall be effective immediately upon posting to
    this site.</p>
</div>
@endsection
